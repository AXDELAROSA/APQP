...
AS
	DECLARE  @VP_MENSAJE				VARCHAR(300) = ''
			,@VP_APQP_TEAM_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_TEAM		DATE
			,@VP_APQP_TOOL_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_TOOL		DATE
			,@VP_APQP_QUAL_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_QUAL		DATE
			,@VP_APQP_FLOOR_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_FLOOR		DATE
			,@VP_APQP_FLOW_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_FLOW		DATE
			,@VP_APQP_PFMEA_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_PFMEA		DATE
			,@VP_APQP_CONTROL_SUMMARY	DECIMAL(10,2)=0--			,@VP_F_COMPLETED_CONTROL	DATE
			,@VP_APQP_RISK_SUMMARY		DECIMAL(10,2)=0--			,@VP_F_COMPLETED_RISK		DATE
	-- ///////////////////////////////////////////
	-- =========================================	-- =========================================
