...
AS
	...
	(	K_TIPO_DOCUMENTO		INT
		...
		,SUMMARY				DECIMAL(10,4) NOT NULL DEFAULT 0
		--,F_COMPLETED			DATE	DEFAULT NULL
	)

	SELECT	TOP(1)	@VP_APQP_TEAM_SUMMARY		= APQP_TEAM_SUMMARY			/	100	FROM APQP_TEAM_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_TEAM_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_TOOL_SUMMARY		= APQP_TOOL_SUMMARY			/	100	FROM APQP_TOOL_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_TOOL_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_QUAL_SUMMARY		= APQP_QUAL_SUMMARY			/	100	FROM APQP_QUAL_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_QUAL_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_FLOOR_SUMMARY		= APQP_FLOOR_SUMMARY		/	100	FROM APQP_FLOOR_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_FLOOR_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_FLOW_SUMMARY		= APQP_FLOW_SUMMARY			/	100	FROM APQP_FLOW_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_FLOW_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_PFMEA_SUMMARY		= APQP_PFMEA_SUMMARY		/	100	FROM APQP_PFMEA_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_PFMEA_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_CONTROL_SUMMARY	= APQP_CONTROL_SUMMARY		/	100	FROM APQP_CONTROL_HDR	WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_CONTROL_HDR		ASC
	SELECT	TOP(1)	@VP_APQP_RISK_SUMMARY		= APQP_RISK_SUMMARY			/	100	FROM APQP_RISK_HDR		WHERE	K_APQP_MODEL_HDR = @PP_K_APQP_MODEL_HDR	ORDER BY K_APQP_RISK_HDR		ASC
