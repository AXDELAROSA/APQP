...
AS
	-- ===========================
IF	(	SELECT	COUNT(K_APQP_MODEL_HDR_TYPE) 
		FROM	APQP_MODEL_HDR_TYPE
		WHERE	K_APQP_MODEL_HDR_TYPE	= @PP_K_APQP_MODEL_HDR_TYPE )	> 0
BEGIN
	UPDATE	APQP_MODEL_HDR_TYPE
	SET	[D_APQP_MODEL_HDR_TYPE]	= @PP_D_APQP_MODEL_HDR_TYPE, 
		[C_APQP_MODEL_HDR_TYPE]	= @PP_C_APQP_MODEL_HDR_TYPE, 
		[S_APQP_MODEL_HDR_TYPE]	= @PP_S_APQP_MODEL_HDR_TYPE, 
		[O_APQP_MODEL_HDR_TYPE]	= @PP_O_APQP_MODEL_HDR_TYPE, 
		[L_APQP_MODEL_HDR_TYPE]	= @PP_L_APQP_MODEL_HDR_TYPE
	WHERE	K_APQP_MODEL_HDR_TYPE	= @PP_K_APQP_MODEL_HDR_TYPE
END
ELSE
BEGIN
...
EXECUTE [dbo].[PG_CI_APQP_MODEL_HDR_TYPE]  0, 139,	01, 'NUEVO MODELO'				,'' , 'NVOMOD'	, 30 , 1
EXECUTE [dbo].[PG_CI_APQP_MODEL_HDR_TYPE]  0, 139,	02, 'CAMBIO INGENIERÍA'			,'' , 'CMBING'	, 10 , 1
EXECUTE [dbo].[PG_CI_APQP_MODEL_HDR_TYPE]  0, 139,	03, 'SIN CAMBIOS'				,'' , 'NOCMBI'	, 05 , 1
EXECUTE [dbo].[PG_CI_APQP_MODEL_HDR_TYPE]  0, 139,	04, 'CAMBIO PRECIOS'			,'' , 'CMBIPR'	, 20 , 1
SET NOCOUNT OFF
GO
...
CREATE TABLE [dbo].[APQP_MODEL_HDR]	(
			...
			-- ===========================
			[K_QUOTE_TRIM_LEVEL]				[INT]NOT NULL DEFAULT 0,
