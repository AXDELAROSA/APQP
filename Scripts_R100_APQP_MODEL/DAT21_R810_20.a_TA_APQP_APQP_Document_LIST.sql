...
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,10,10,	'New materials?'													,'Guillermo Mata / Jorge Holguin'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,10,20,	'Quick change?'														,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,10,30,	'Volume fluctuations?'												,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,10,40,	'Mistake proofing?'													,'Miguel Carrasco'

-- ==================================================================================================================================================================
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,20,00,	'Have lists been prepared identifying:'								,''

EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,20,10,	'New equipment?'													,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,20,20,	'New tooling?'														,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,20,30,	'New test equipment?'												,'Omar Decena'

-- ==================================================================================================================================================================
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,00,	'Has acceptance criteria been agreed upon for:'																			,''

EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,10,	'New equipment?'																										,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,20,	'New tooling?'																											,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,30,	'New test equipment?'																									,''
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,40,	'Will a preliminary capability study be conducted at the tooling and/or equipment manufacturer?'						,'Jorge Holguin / Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,50,	'Has test equipment feasibility and accuracy been established?'															,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,60,	'Is a preventive maintenance plan complete for equipment and tooling?'													,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,70,	'Are setup instructions for new equipment and tooling complete and understandable?'										,'Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,80,	'Will capable gages be available to run preliminary process capability studies at the equipment supplier´s facility?'	,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,90,	'Will preliminary process capability studies be run at the processing plant?'											,'Omar Decena / J. Holguin'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,100,	'Have process characteristics that affect special product characteristics been identified?'								,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,110,	'Were special product characteristics used in determining acceptance criteria?'											,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,210,	'Does the manufacturing equipment have sufficient capacity to handle forecasted production and service volumes?'		,'Omar Decena / J. Holguin'
EXECUTE [dbo].[PG_CI_APQP_TOOL_ACTIVITY_LIST]  0, 139,	1,1,30,310,	'Is testing capacity sufficient to provide adequate testing?'															,'Omar Decena / J. Holguin'
SET NOCOUNT OFF
GO
...
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,10,40,	'Has the quality assurance system been reviewed using the Chrysler, Ford, and General Motors Quality System Assessment?'					,'Omar Decena'
		  
-- ==================================================================================================================================================================
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,20,00,	'Are there sufficient personnel identified to cover:'							,''

EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,20,10,	'Control plan requirements?'																												,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,20,20,	'Layout inspection?'																														,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,20,30,	'Engineering performance testing?'																											,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,20,40,	'Problem resolution analysis?'																												,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,25,00,	'Is there a documented training program that:'																								,''
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,25,10,	'Includes all employees?'																													,'Adriana de la Ree'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,25,20,	'Lists whose been trained?'																													,'Adriana de la Ree'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,25,30,	'Provides a training schedule?'																												,'Adriana de la Ree'

-- ==================================================================================================================================================================
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,00,	'Has training been completed for:'											,''

EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,10,	'Statistical process control?'																												,'J. Holguin/ Omar D'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,20,	'Capability studies?'																														,'J. Holguin/ Omar D'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,30,	'Problem solving?'																															,'J. Holguin/ Omar D'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,40,	'Mistake proofing?'																															,'J. Holguin/ Omar D'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,50,	'Other topics as identified?'																												,''
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,30,60,	'Is each operation provided with process instructions that are keyed to the control plan?'													,'Omar Decena'
...
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,45,60,	'Is there a procedure to implement, maintain, and establish reaction plans for statistical control charts?'	,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,45,70,	'Is there an effective root cause analysis system in place?'												,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,45,80,	'Have provisions been made to place the latest drawings and specifications at the point of the inspection?'	,'Guillermo M. / Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,45,90,	'Are forms/logs available for appropriate personnel to record inspection results?'							,'Omar Decena'
...
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,50,10,	'Inspection gages?'																							,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,50,20,	'Gage instructions?'																						,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,50,30,	'Reference samples?'																						,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,50,40,	'Inspection logs?'																							,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,50,50,	'Have provisions been made to certify and routinely calibrate gages and test equipment?'					,'Omar Decena'

-- ==================================================================================================================================================================
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,60,00,	'Have required measurement system capability studies been:'								,''

EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,60,10,	'Completed?'																													,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,60,20,	'Acceptable?'																													,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,60,30,	'Are layout inspection equipment and facilities adequate to provide initial and ongoing layout of all details and components?'	,'Omar Decena'
...
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,10,	'Characteristics to be inspected?'																			,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,20,	'Frequency of inspection?'																					,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,30,	'Sample size?'																								,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,40,	'Designated location for approved product?'																	,'O. Decena / Guillermo Mata'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,50,	'Disposition of nonconforming products?'																	,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,60,	'Is there a procedure to identify, segregate, and control nonconforming products to prevent shipment?'		,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,70,	'Are rework/repair procedures available?'																	,''
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,80,	'Is there a procedure to requalify repaired/reworked material?'												,''
...
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,100,	'Are periodic audits of outgoing products planned and implemented?'											,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,110,	'Are periodic surveys of the quality system planned and implemented?'										,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_QUAL_ACTIVITY_LIST]  0, 139,	1,1,70,120,	'Has the customer approved the packaging specification?'													,'Omar Decena'
SET NOCOUNT OFF
GO
...
EXECUTE [dbo].[PG_CI_APQP_FLOOR_ACTIVITY_LIST]  0, 139,	1,1,30,70,	'Are controls adequate to prevent movement of nonconforming incoming material to storage or point of use?'												,'Miguel Carrasco'
SET NOCOUNT OFF
GO
...
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,10,	'Does the flow chart illustrate the sequence of production and inspection stations?'							,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,20,	'Were all appropriate FMEA´s (SFMEA, DFMEA) available and used as aids to develop the process flow chart?'		,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,30,	'Is the flow chart keyed to product and process checks in the control plan?'									,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,40,	'Does the flow chart describe how the product will move, i.e., roller conveyor, slide containers, etc.?'		,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,50,	'Has the pull system/optimization been considered for this process?'											,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,60,	'Have provisions been made to identify and inspect reworked product before being used?'							,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_FLOW_ACTIVITY_LIST]  0, 139,	1,1,10,70,	'Have potential quality problems due to handling and outside processing been identified and corrected?'			,'Miguel Carrasco'
SET NOCOUNT OFF
GO
...
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,10,	'Was the Process FMEA prepared using the Chrysler, Ford, and General Motors guidelines?'													,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,20,	'Have all operations affecting fit, function, durability, governmental regulations and safety been identified and listed sequentially?'		,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,30,	'Were similar part FMEA´s considered?'																										,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,40,	'Have historical campaign and warranty data been reviewed?'																					,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,50,	'Have appropriate corrective actions been planned or taken for high risk priority items?'													,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,60,	'Have appropriate corrective actions been planned or taken for high severity numbers?'														,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,70,	'Were risk priorities numbers revised when corrective action was completed?'																,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,80,	'Were high severity numbers revised when a design change was completed?'																	,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,90,	'Do the effects consider the customer in terms of the subsequent operation, assembly, and product?'											,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,100,	'Was warranty information used as an aid in developing the Process FMEA?'																	,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,110,	'Were customer plant problems used as an aid in developing the Process FMEA?'																,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,120,	'Have the causes been described in terms of something that can be fixed or controlled?'														,'Miguel Carrasco'
EXECUTE [dbo].[PG_CI_APQP_PFMEA_ACTIVITY_LIST]  0, 139,	1,1,10,130,	'Where detection is the major factor, have provisions been made to control the cause prior to the next operation?'							,'Miguel Carrasco'
SET NOCOUNT OFF
GO
...
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,10,	'Was the control plan methodology referenced in Section 6 used in preparing the control plan?'										,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,20,	'Have all known customer complaints been identified to facilitate the selection of special product/process characteristics?'		,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,30,	'Are all special product/process characteristics included in the control plan?'														,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,40,	'Were SFMEA, DFMEA, and PFMEA used to prepare the control plan?'																	,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,50,	'Are material specifications requiring inspection identified?'																		,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,60,	'Does the control pan address incoming (material/components) through processing/assembly including packaging?'						,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,70,	'Are engineering performance testing requirements identified?'																		,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,80,	'Are gages and test equipment available as required by the control plan?'															,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,90,	'If required, has the customer approved the control plan?'																			,'Omar Decena'
EXECUTE [dbo].[PG_CI_APQP_CONTROL_ACTIVITY_LIST]  0, 139,	1,1,10,100,	'Are gage methods compatible between supplier and customer?'																		,'Omar Decena'
SET NOCOUNT OFF
GO
