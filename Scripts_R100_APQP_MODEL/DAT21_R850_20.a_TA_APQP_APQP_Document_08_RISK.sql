...
CREATE TABLE [dbo].[APQP_CONTROL_HDR]	(
			...
			-- ===========================
			[L_APQP_CONTROL_HDR_LOW]			[INT] NOT NULL DEFAULT 0,
			[L_APQP_CONTROL_HDR_MEDIUM]			[INT] NOT NULL DEFAULT 0,
			[L_APQP_CONTROL_HDR_HIGH]			[INT] NOT NULL DEFAULT 0,
			-- ===========================
			[C_APQP_CONTROL_HDR_MEDIUM]			[VARCHAR](800) NOT NULL DEFAULT '',
			[C_APQP_CONTROL_HDR_HIGH]			[VARCHAR](800) NOT NULL DEFAULT ''
) ON [PRIMARY]
GO
