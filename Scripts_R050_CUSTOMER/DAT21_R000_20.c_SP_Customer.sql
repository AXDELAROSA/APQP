...
AS
	...
	SELECT		TOP (5000)
				...
				-- =============================	
				D_ARCUSFIL_TERMS_PERIOD,
				S_ARCUSFIL_TERMS_PERIOD,
				C_ARCUSFIL_TERMS_PERIOD,
				-- =============================	
				C.*
				-- =============================	
	...
	INNER JOIN	ARCUSFIL_TERMS_PERIOD			ON	ARCUSFIL_TERMS_PERIOD.K_ARCUSFIL_TERMS_PERIOD	= C.K_ARCUSFIL_TERMS_PERIOD
				-- =============================
	WHERE		C.L_BORRADO<>1
	AND			C.L_ARCUSFIL=1
	AND			A4GLIdentity<>0
...
-- /////////////////////////////////////////////////////////////////////
	...
	SET		
			...
			[USER_DEF_FLD_2]				= 0,
			[K_ARCUSFIL_TERMS_PERIOD]		= @PP_K_ARCUSFIL_TERMS_PERIOD,
			-- ====================		
			[F_CAMBIO]						= GETDATE(), 
